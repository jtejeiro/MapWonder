...
class MapPoisAnnotationView: MKAnnotationView {

    weak var calloutView: MapPoisView?
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        if selected {
            ...
            let calloutView = MapPoisView(annotation: annotation as! PoisAnnotation)
